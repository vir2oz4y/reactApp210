...
const EditProductPopup = ({open, onClose, Product:ProductEdit, onEdit}: Props) => {
    ...
    const onEditClick = () => {
        ...
        nalyaykinAxios.patch<{ item:Product }>('https://canstudy.ru/orderapi/Product',
            {
                item:{
                    ...Product
                }
    ...
    const getManufacturies = () => {
        nalyaykinAxios.get<{ items: Manufacturer[] }>('https://canstudy.ru/orderapi/manufacturer/list')
            .then(res => {
