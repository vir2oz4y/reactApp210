...
import KurgankovPage, { kurgankovAxios } from '../KurgankovPage';
import KurgankovPopup from '../../../../Components/Kurgankov/KurgankovPopup/KurgankovPopup';
...
const CategoryPage = () => {
    ...
    const onDeleteClick = (id: number) => {
        kurgankovAxios.delete(`https://canstudy.ru/orderapi/category/${id}`)
            .then(res => {
