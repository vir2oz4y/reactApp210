...
import ArtamonovPage, { artamonovAxios } from '../ArtamonovPage';
import ArtamonovPopup from '../../../../Components/Artamonov/ArtamonovPopup/ArtamonovPopup';
...
const CategoryPage = () => {
    ...
    const onDeleteClick = (id: number) => {
        artamonovAxios.delete(`https://canstudy.ru/orderapi/category/${id}`)
            .then(res => {
