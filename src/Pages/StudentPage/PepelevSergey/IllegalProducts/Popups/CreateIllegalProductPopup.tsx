...
type Props = IPopup & {
    onCreate: (newIllegalProduct: IllegalProduct) => void;
}
...
const CreateIllegalProductPopup = ({open, onClose, onCreate}: Props) => {
    ...
    const [IllegalProduct, setIllegalProduct] = useState<IllegalProduct>({
        categoryId: 0,
        categoryName: "",
        cost: 0,
        description: "",
    ...
    const onCreateClick = () => {
        createIllegalProduct();

        onClose();
    }

    console.log(IllegalProduct)
...
export default CreateIllegalProductPopup;