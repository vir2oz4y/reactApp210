...
import DyakovDanilPage, { dyakovAxios } from '../DyakovDanilPage';
import DyakovPopup from '../../../../Components/Dyakov/DyakovPopup/DyakovPopup';
...
const CategoryPage = () => {
    ...
    const onDeleteClick = (id: number) => {
        dyakovAxios.delete(`https://canstudy.ru/orderapi/category/${id}`)
            .then(res => {
